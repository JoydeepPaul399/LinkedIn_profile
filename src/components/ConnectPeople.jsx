        ...
        <div className='flex flex-col w-[80%] md:w-[90%] justify-start gap-4 mt-4 mb-4 ml-4'>
            <div className='flex gap-1.5 justify-start items-start w-full'>
                ...
                <div className='flex flex-col items-start'>
                    ...
                    <p className='line-clamp-2 text-ellipsis text-[#434343] text-sm'>{desc}</p>
                </div>
            </div>
            <div className='flex justify-start ml-14'>
                <div className="shadow-[0_0_0_1.3px_#404040] text-[#404040] rounded-2xl px-4 py-1 font-semibold cursor-pointer hover:bg-[#f2f2f2] hover:shadow-[0_0_0_2px_#171717] w-fit flex items-center group  ">
                    <div className='group-hover:text-black'>
                        <CgUserAdd />
                    </div>
                    <span className='group-hover:text-black font-semibold'>Connect</span>
                </div>
            </div>
        </div>
    )
