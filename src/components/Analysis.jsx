    ...
    <div className="w-full h-full">
      <div className="w-full h-full px-4 mt-4 mb-4">
        <div className="h-full w-full mx-3 mb-2">
          <h2 className="text-base font-semibold text-[#000000E6] dark:text-white">
            Analytics
          </h2>
        ...
        <div className="flex flex-col sm:flex-row justify-center items-start gap-2 w-full h-full px-2">
          {/* 1 */}
          <div className="w-full h-full">
            <div>
