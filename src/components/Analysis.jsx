  ...
  return (
    <div className='w-full h-full'>
      <div className='w-full h-full px-4 mt-4 mb-4'>
        <div className="h-full w-full mx-3 mb-2">
          <h2 className="text-base font-semibold text-[#000000E6] dark:text-white">Analytics</h2>
        ...
        <div className='flex justify-center items-start gap-2 w-full h-full px-2'>
          ...
          <div className='w-full h-full'>
            <div>
              <div className='flex items-center justify-start gap-1 font-semibold text-gray-900 dark:text-gray-300'>
            ...
            <div>
              <span className='text-gray-700 dark:text-gray-400'>Discover who's viewed your profile.</span>
            </div>
          </div>
          ...
          <div className='w-full h-full'>
            ...
            <div className='flex flex-col items-start'>
              <span className='text-gray-700 dark:text-gray-400'>Check out who's engaging with your posts.</span>
              <span className='text-gray-700 dark:text-gray-400'>Past 7 days</span>
            </div>
          </div>
          ...
          <div className='w-full h-full'>
            ...
            <div>
              <span className='text-gray-700 dark:text-gray-400'>See how often you appear in search results.</span>
            </div>
          </div>
        </div>
      </div>
      ...
      {/* Show analytics btn  */}
      <div className='flex justify-center items-center w-full h-full py-2 cursor-pointer hover:bg-gray-200 dark:hover:bg-gray-700 transition-all duration-300 ease-in'>
        <div className='flex justify-center items-center'>
          <span className='text-gray-900 dark:text-gray-300'>Show all analytics</span>
          <div>
            <CgArrowRight className='text-gray-900 dark:text-gray-300' />
          </div>
        </div>
      </div>
    </div>
