  ...
  return (
    <>
        ...
        <div className="mt-18 flex mx-8 max-w-full justify-between items-center">
          <div>
            <div className="flex gap-2 items-center">
              <h1 className="font-bold text-3xl text-[#1d1d1d]">
                Joydeep Paul
              </h1>
              <div>
                <svg
      ...
      <div className="mx-8 mt-1.5 flex items-center gap-2">
        <button className="border-none rounded-2xl px-4 py-1 bg-[#0a66c2] text-white font-semibold cursor-pointer hover:bg-[#004182] ">Open to</button>
        <button className="shadow-[0_0_0_1.3px_#0a66c2] text-[#0a66c2] rounded-2xl px-4 py-1 font-semibold cursor-pointer hover:bg-[#ebf4fc] hover:shadow-[0_0_0_2px_#004182] ">Add Profile section</button>
        <button className="shadow-[0_0_0_1.3px_#0a66c2] text-[#0a66c2] rounded-2xl px-4 py-1 font-semibold cursor-pointer hover:bg-[#ebf4fc] hover:shadow-[0_0_0_2px_#004182] ">Enhance Profile</button>
        <button className="shadow-[0_0_0_1.3px_#404040] text-[#404040] rounded-2xl px-4 py-1 font-semibold cursor-pointer hover:bg-[#f2f2f2] hover:shadow-[0_0_0_2px_#171717]  ">Resources</button>
      </div>

      <section className="mx-8 mt-6 w-full relative">
        {
            showLeftScrollBtn && (
                <div ref={scrollLeftBtnRef} onClick={scrollLeftBtn} className="absolute top-[30%] bg-[#595d61] rounded-full p-0.5 cursor-pointer select-none text-white ">
                    <MdKeyboardArrowLeft size={28} />
                </div>
            )
        }
        <ul ref={ref} className="w-full flex gap-4 overflow-x-auto  scroll-smooth hide-scrollbar pr-10">
            <li className="w-[45%] px-2 py-2 h-22 rounded-xl bg-[#dfe9f2] group min-w-[386px]">
                <div className="flex justify-between text-sm">
                    <p className="font-semibold">Open to work</p>
                    <button><GrFormEdit size={22} /></button>
                </div>
                    <p className="truncate overflow-hidden whitespace-nowrap w-full text-sm" >Web Developer, Frontend Developer and Full Stack Developer roles</p>
                    <p className="text-sm text-[#0a66c2] font-semibold cursor-pointer group-hover:underline ">Show details</p>
            </li>

            <li className="w-[45%] px-2 py-2 h-22 rounded-xl border border-[#e8e8e8] group min-w-[386px]">
                <div className="flex justify-between text-sm">
                    <p className="text-[#000000E6] text-sm"><strong>Share that you're hiring </strong>and attract qualified candidates.</p>
                    <button><IoClose size={20} /></button>
                </div>
                    
                    <p className="text-sm text-[#0a66c2] font-semibold cursor-pointer group-hover:underline ">Get Started</p>
            </li>

            <li className="w-[45%] px-2 py-2 h-22 rounded-xl border border-[#e8e8e8] group min-w-[386px]">
                <div className="flex justify-between text-sm">
                    <p className="text-[#000000E6] text-sm"><strong>Showcase your services </strong>as a section on your profile so your business can be easily discovered.</p>
                    <button><IoClose size={20} /></button>
                </div>
            ...
            <li className="w-[45%] px-2 py-2 h-22 rounded-xl border border-[#e8e8e8] group min-w-[386px]">
                <div className="flex justify-between text-sm">
                    <p className="text-[#000000E6] text-sm"><strong>Tell non-profits </strong>you're interested in getting involved with your time and skills</p>
                    <button><IoClose size={20} /></button>
                </div>
        ...
        {
            showRightScrollBtn && (
                <div onClick={scrollRightBtn} className="absolute top-[30%] right-10 bg-[#595d61] rounded-full p-0.5 cursor-pointer text-white select-none">
