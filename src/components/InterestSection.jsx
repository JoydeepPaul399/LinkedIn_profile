  ...
  return (
    <section className="w-full h-full">
      ...
      <div className="flex gap-6 pb-2 px-4">
        <button className="font-semibold text-[#191919] dark:text-[#ddd]">
          Companies
        </button>
        <button className="font-semibold text-[#191919] dark:text-[#ddd]">
          Schools
      ...
      <div className="px-8 flex flex-col sm:flex-row w-full">
        <div className="flex items-start gap-3 w-1/2">
          ...
          <div className="flex flex-col gap-0.5">
            ...
            <p className="text-[#191919] dark:text-[#aaa]">
              1,322,269 followers
            </p>
        ...
        <div className="flex items-start gap-3 w-1/2">
          ...
          <div className="flex flex-col gap-0.5">
            <h4 className="text-[#191919] dark:text-[#ddd]">
