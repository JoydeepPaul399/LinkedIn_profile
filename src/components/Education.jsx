  ...
  return (
    <div className="w-full h-full">
      ...
      <div className="w-full h-full px-4 flex gap-2 justify-start items-start">
        <img className="h-12 rounded" src={amityImage} alt="Amity University" />
        <div>
          ...
          <div className="flex flex-col">
            <span className="text-sm text-[#00000099] dark:text-gray-400">Jan 2022 - Mar 2025</span>
            <span className="text-sm text-[#000000E6] dark:text-gray-300">Grade: A</span>
          </div>
        </div>
      </div>
    </div>
