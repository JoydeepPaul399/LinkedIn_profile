  ...
  return (
    <div className="w-full h-full">
      <div className="flex justify-between items-center py-2 px-4">
        <div>
          <h1 className="font-semibold text-lg text-[#191919] dark:text-gray-100">Education</h1>
        </div>
      ...
      <div className="w-full h-full px-4 flex gap-2 justify-start items-start">
        <img className="h-12 rounded" src={user?.clgImg} alt="Amity University" />
        <div>
          ...
          <div className="flex flex-col">
            <span className="text-sm text-[#00000099] dark:text-gray-400">{user?.courseDuration}</span>
            <span className="text-sm text-[#000000E6] dark:text-gray-300">Grade: {user?.grade}</span>
          </div>
        </div>
      </div>
    </div>
