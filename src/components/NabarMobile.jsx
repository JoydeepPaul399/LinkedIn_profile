...
const NavbarMobile = () => {
    ...
    return (
        <div className={`flex flex-row flex-wrap justify-around items-center gap-4 px-2 py-3 bg-white dark:bg-gray-900 w-full z-50 border-t border-gray-300 dark:border-gray-700 transition-transform duration-300 transform origin-top ${isVisible ? "scale-y-100 opacity-100": "scale-y-0 opacity-0"} `}>
            {/* Home */}
            ...
            <div className="flex flex-col items-center group cursor-pointer">
                ...
                <div className="hidden md:flex items-center">
                    ...
                    <MdOutlineArrowDropDown className="text-[#666666] dark:text-gray-300 group-hover:text-black dark:group-hover:text-white" size={20} />
                </div>
            </div>
