  ...
  return (
    <div className="w-full h-full">
      ...
      <div className="border border-[#e8e8e8] dark:border-gray-700 mx-4 rounded-xl">
        <div>
          <span className="text-xs text-[#828282] dark:text-gray-400 px-2">
            Link
          </span>
        </div>
        <Link
          className="grid grid-cols-1 sm:grid-cols-2 justify-center items-start gap-3 bg-[#f8fafd] dark:bg-gray-800 rounded-b-xl"
        ...
        >
          ...
          <div className="flex flex-col gap-1 px-2 py-3">
            <h2 className="text-base font-semibold text-[#000000E6] dark:text-gray-100">
              My Portfolio
            </h2>
            <span className="text-sm text-[#828282] dark:text-gray-400 break-all">
              joydeepmyportfoliosite.netlify.app
            </span>
            <span className="text-sm overflow-hidden text-ellipsis line-clamp-5 text-[#00000099] dark:text-gray-300">
              Explore my personal portfolio showcasing web development projects,
              including responsive websites, frontend designs, and full stack
              applications built using modern technologies like React, Node.js,
              and more.
            </span>
          </div>
        </Link>
